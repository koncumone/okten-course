...
coursesArray.forEach(course => {
    ...
    monthDurationBlock.className = 'month-duration-block';
    monthDurationBlock.innerText = `Month Duration: ${course.monthDuration}`;

    let hourDurationBlock = document.createElement('div');
    hourDurationBlock.className = 'hour-duration-block';
    hourDurationBlock.innerText = `Hour Duration: ${course.hourDuration}`;

    let modulesList = document.createElement('ul');
    
    course.modules.forEach(modul => {
        let moduleItem = document.createElement('li');
        moduleItem.innerText = modul;
...
btn.onclick = function () {
    ...
    let removeBtn = document.getElementById(btn.id)
    removeBtn.remove()
